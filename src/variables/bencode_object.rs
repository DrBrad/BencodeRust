...
pub struct BencodeObject<V>(pub HashMap<ByteWrapper, V>);
...
impl<V> ToBencode for BencodeObject<V> where V: ToBencode {
    ...
    fn to_bencode(&self) -> Vec<u8> {
        ...
        buf.push(<HashMap<ByteWrapper, V> as ToBencode>::TYPE.prefix() as u8);
        ...
        buf.push(<HashMap<ByteWrapper, V> as ToBencode>::TYPE.suffix() as u8);
        buf
    }
}
